...
const Home = () => {
  return (
    <div name="home" style={{ zIndex: 5 }} className='bg-gradient-to-t from-black to-slate-900 bg-blend-overlay flex justify-center items-center h-screen sm:max-h-screen'>
      <div className='flex flex-col md:flex-row w-2/3 items-center md:items-start '>
        <div className='flex items-start justify-start flex-col text-white md:mr-32'>
